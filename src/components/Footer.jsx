...
function Footer() {
  return (
    <footer className="bg-[#000d3d] py-4 mx-auto">
      <section className="container px-4 flex items-center justify-between gap-x-4 mx-auto">
        <div>
          <p className="text-white"> Copyright © 2023. All rights are reserved</p>
        </div>
        <div className="flex gap-x-2 items-center">
          <Link target = "_blank" to='https://github.com/devKongkon'>
            <svg
